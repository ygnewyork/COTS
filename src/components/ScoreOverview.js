...
export default function ScoreOverview({ clarityMode }) {
  ...
  return (
    <motion.div
      ...
      className="bg-clarity-card rounded-2xl border border-clarity-border p-6 card-hover"
    >
      <div className="text-center mb-6">
        <p className="text-gray-400 text-sm mb-2">Your Credit Score</p>
        <div className="relative inline-flex items-center justify-center">
          <svg className="w-48 h-48 transform -rotate-90">
            <circle cx="96" cy="96" r="88" stroke="currentColor" strokeWidth="8" fill="transparent" className="text-clarity-border" />
            <motion.circle
              cx="96" cy="96" r="88"
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-gray-400 text-sm mt-1">Fair</span>
          </div>
        </div>
      ...
      {clarityMode && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4 mb-6">
          <p className="text-sm text-gray-300">
            <span className="text-purple-400 font-medium">What is 682?</span> Think of it like a grade out of 850. 
      ...
      <div className="mb-6">
        ...
        <div className="h-2 bg-clarity-border rounded-full overflow-hidden">
      ...
      <div className="mb-6">
        <h4 className="text-sm font-medium text-gray-400 mb-3">6-Month Trend</h4>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-clarity-dark rounded-xl p-3">
          <div className="flex items-center gap-2 mb-1"><Target className="w-4 h-4 text-purple-400" /><span className="text-xs text-gray-400">Next Goal</span></div>
          <p className="text-sm font-medium text-white">700 Score</p>
          <p className="text-xs text-gray-500">18 pts away</p>
        </div>
        <div className="bg-clarity-dark rounded-xl p-3">
          <div className="flex items-center gap-2 mb-1"><Award className="w-4 h-4 text-cyan-400" /><span className="text-xs text-gray-400">Rank</span></div>
          <p className="text-sm font-medium text-white">Top 45%</p>
